...
{
    public class AnalysisEditHandler : IRequestHandler<AnalysisEditCommand, BaseResponse<bool>>
    {
        private readonly IAnalysisRepository _analysisRepository;
        private readonly IMapper _mapper;

        public AnalysisEditHandler(IAnalysisRepository analysisRepository, IMapper mapper)
        {
            _analysisRepository = analysisRepository;
            _mapper = mapper;
        }

        public async Task<BaseResponse<bool>> Handle(AnalysisEditCommand request, CancellationToken cancellationToken)
        {
